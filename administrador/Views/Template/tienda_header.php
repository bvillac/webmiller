...
<html lang="en">
<head>
	<title><?= TITULO_EMPRESA ?></title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="<?php echo media(); ?>/images/site/favicon.ico"/>
<!--===============================================================================================-->
...
<body class="animsition">
	...
	<header>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<a href="<?= base_url(); ?>" class="logo">
						<img src="<?= media(); ?>/images/site/logotienda.png" alt="<?= TITULO_EMPRESA ?>">
					</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="#">Servicios</a>
								<ul class="sub-menu">									
									<li><a href="<?= base_url(); ?>/servicios/sistemasea">SEA PYMES</a></li>
									<li><a href="<?= base_url(); ?>/servicios/consultoria">Consultoría Informática</a></li>
									<li><a href="<?= base_url(); ?>/servicios/soporte">Mantenimiento de Equipos</a></li>
								</ul>
							</li>
							<li>
		...
		<!-- Header Mobile Presenta Moviles -->
		<div class="wrap-header-mobile">
			<!-- Logo moblie -->		
			<div class="logo-mobile">
				<a href="<?= base_url(); ?>"><img src="<?= media(); ?>/images/site/logotienda.png" alt="<?= TITULO_EMPRESA ?>"></a>
			</div>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="<?= base_url(); ?>/contacto/contacto">Contacto</a>
				</li>
