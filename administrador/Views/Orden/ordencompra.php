                          ...
                          <blockquote class="card-blockquote">
                              <!-- <div class="row">
                                <div class="form-group col-md-3">
                                  <label for="txtSecuencia">Número <span class="required">*</span></label>
                                  <input class="form-control" id="txtSecuencia" name="txtSecuencia" type="text" required="">
                                </div>   
                              ...
                              <div class="row">
                                <div class="form-group col-md-3">                   
                                    ...
                                    <div class="input-group">
                                      <input class="form-control" id="txtCodproveedor" value="" name="txtCodproveedor" type="text" required="">                                 
                                ...
                                <div class="form-group col-md-6">
                                  <h5 class="text-right">N°: <span id="lbl_Secuencia"><?= $data['Secuencia'] ?></span></h5>
                                </div>
                                <div class="form-group col-md-3">
                              ...
                              <div class="row">
                                <div class="form-group col-md-2">                   
                                    <b>Ruc :</b><span id="lbl_Ruc"></span>
                                </div>   
                                <div class="form-group col-md-4">
                                    <b>Nombre :</b><span id="lbl_Nombre"></span>
                                </div>
                                <div class="form-group col-md-4">
                                    <b>Dirección :</b><span id="lbl_Direccion"></span>                           
                                </div> 
                                <div class="form-group col-md-2">
                              ...
                              <!-- <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                  <label for="txtNomproveedor">Nombre Proveedor <span class="required">*</span></label>
                                  <input class="form-control" id="txtNomproveedor" name="txtNomproveedor" disabled type="text" required="">
                                </div>
                                <div class="form-group col-md-3">
                                  <label for="txtFechaIng">Fecha Ingreso <span class="required">*</span></label>
                                  <input class="form-control" id="txtFechaIng" name="txtFechaIng" value="<?= date("Y-m-d") ?>" disabled type="text" required="">
                                </div>                      
                              </div>
                              <div class="row">
                                <div class="form-group col-md-3">
                                  <label for="txtRuc">Ruc <span class="required">*</span></label>
                                  <input class="form-control" id="txtRuc" name="txtRuc" disabled type="text" required="">
                                </div>   
                                <div class="form-group col-md-6">
                                  <label for="txtDireccion">Dirección <span class="required">*</span></label>
                                  <input class="form-control" id="txtDireccion" name="txtDireccion" disabled type="text" required="">
                                </div>  
                                <div class="form-group col-md-3">
                                     <button id="cmd_guardar" class="btn btn-primary" type="button">Guardar</button>
                                </div>                    
